# Домашнее задание к занятию 1 «Disaster recovery и Keepalived» - Пономарёв Сергей
...
Установлен nginx и keepalived по адресу 192.168.99.147 (MASTER), 192.168.99.93 (BACKUP) 
Виртуальный IP: 192.168.99.15

![](image/image2.png)

[файл](files/keepalived.conf)

Скриншоты с демонстрацией переезда плавающего ip на другой сервер в случае недоступности порта или файла index.html

![](image/image3.png)

[файл](files/check_nginx.sh)
